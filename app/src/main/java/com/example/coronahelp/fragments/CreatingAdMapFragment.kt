...
class CreatingAdMapFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        buttonSearchAddress.setOnClickListener {
            val searched_location = getLocationFromAddress(requireContext(),editTextAddress.text.toString())
            map!!.clear()
        ...
        buttonAccept.setOnClickListener {
            val markerLatLng = markerLocation.toString()
            val action =
                CreatingAdMapFragmentDirections.actionCreatingAdMapFragmentToCreateAnnouncement2(
                    markerLatLng
                )
